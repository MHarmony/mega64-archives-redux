...
1. Run the full mega64-archives-redux test suite and ensure it passes.
...
1. In GitHub, send a pull request to `mega64-archives-redux:main`.

- If we suggest changes then:

  - Make the required updates.
  - Re-run the mega64-archives-redux test suites to ensure tests are still passing.
...
- **build**: Changes that affect the build system or external dependencies (example scopes: gulp, broccoli, pnpm)
...
If your change affect more than one package, separate the scopes with a comma (e.g. `api,ui`).
...
[github]: https://github.com/MHarmony/mega64-archives-redux
[new_issue]: https://github.com/MHarmony/mega64-archives-redux/issues
[gh_prs]: https://github.com/MHarmony/mega64-archives-redux/pulls
